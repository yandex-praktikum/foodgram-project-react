    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, help_text='введите Ваш псевдоним', max_length=150, unique=True, validators=[recipes.validators.min_long_name_validator], verbose_name='имя пользователя')),
                ('first_name', models.CharField(help_text='введите Ваше имя', max_length=150, validators=[recipes.validators.min_long_name_validator], verbose_name='Имя')),
                ('last_name', models.CharField(help_text='введите Вашу фамилию', max_length=150, validators=[recipes.validators.min_long_name_validator], verbose_name='Фамилия')),
