...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator], verbose_name='количество')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveIntegerField(help_text='введите время приговления по рецепту в минутах', validators=[recipes.validators.MinValueTimeCookingValidator], verbose_name='время приговления по рецепту в минутах')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#ffffff', help_text='введите цвет тега в HEX-формате', max_length=7, unique=True, validators=[recipes.validators.HexCheckValidation], verbose_name='цвет тега')),
