    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveIntegerField(help_text='введите время приговления по рецепту в минутах', validators=[recipes.validators.MinValueTimeCookingValidator(limit_value=1)], verbose_name='время приговления по рецепту в минутах')),
            ],
            options={
                'verbose_name': 'Рецепт',
