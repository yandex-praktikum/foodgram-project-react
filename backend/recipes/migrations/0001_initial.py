# Generated by Django 4.2.6 on 2023-11-05 21:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=200, validators=[recipes.validators.min_long_name_validator], verbose_name='Название ингредиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='введите название рецепта', max_length=200, validators=[recipes.validators.min_long_name_validator], verbose_name='название рецепта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='введите имя тега', max_length=200, unique=True, validators=[recipes.validators.min_long_name_validator], verbose_name='название тега')),
                ...
                ('slug', models.CharField(help_text='slug имя тега', max_length=200, validators=[recipes.validators.min_long_name_validator], verbose_name='slug тега')),
            ],
            options={
                'verbose_name': 'Тэг',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop_carts_recipes', to='recipes.recipe', verbose_name='рецепт')),
            ],
            options={
