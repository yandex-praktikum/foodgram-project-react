...
Проект доступен по [адресу](https://foodgramrzn.ddns.net/)   
...
1. Клонируйте репозиторий на свой компьютер:
    ...
    ```bash
    git clone https://github.com/VldislavRZN/foodgram-project-react.git
    ```
    ```bash
...
4. В директорию foodgram/ скопируйте файлы docker-compose.production.yml и .env:
    ...
    * SSH_name — имя файла с SSH-ключом (файл без расширения);
...
2. Для адаптации его на своем сервере добавьте секреты в GitHub Actions:
    ...
    SSH_KEY                        # приватный ssh-ключ (cat ~/.ssh/id_rsa) (файл без разсширения)
